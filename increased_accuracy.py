...
# This is the modified file whose accuracy has been improved in Decision Tree and Random Forest.
class DiseasePrediction:
    ...
    # Model Selection
    # Original code changed to increase accuracy in Decision tree and Random Forest 
    ...
    def plot_validation_curve(self):
        ...
        train_scores, test_scores = validation_curve(
            DecisionTreeClassifier(), self.train_features, self.train_labels,
...
if __name__ == "__main__":
    ...
    # Call the plots
    dp.plot_validation_curve()
    dp.plot_learning_curve()
    # Calculate confusion matrix and then plot it
    X_train, y_train, X_val, y_val = dp._train_val_split()
    classifier = dp.select_model()
    classifier = classifier.fit(X_train, y_train)
    y_pred = classifier.predict(X_val)
    conf_mat = confusion_matrix(y_val, y_pred)
    dp.plot_confusion_matrix(conf_mat)